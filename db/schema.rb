...
ActiveRecord::Schema[7.0].define(version: 20_230_322_174_241) do
  ...
  create_table 'columns', force: :cascade do |t|
    ...
    t.index %w[columnable_type columnable_id], name: 'index_columns_on_columnable'
  ...
  create_table 'tasks', force: :cascade do |t|
    ...
    t.index %w[column_type column_id], name: 'index_tasks_on_column'
