...
set :linked_files, fetch(:linked_files, []).push('config/database.yml', 'config/master.key', 'config/puma.rb', 'config/.env.production')
...
set :config_files, %w[config/database.yml config/.env.production]
