...
RSpec.describe 'api/v2/projects', type: :request, swagger_doc: 'v2/swagger.yaml' do
  path '/api/v2/projects' do
  ...
  path '/api/v2/projects/{project_id}/add_member' do
  ...
  path '/api/v2/projects/{project_id}/delete_member/{user_id}' do
    parameter name: :project_id, in: :path, type: :integer, description: 'project_id'
