...
RSpec.describe 'api/v2/desks', type: :request, swagger_doc: 'v2/swagger.yaml' do

  path '/api/v2/projects/{project_id}/desks' do
  ...
  path '/api/v2/projects/{project_id}/desks/{id}' do
    # You'll want to customize the parameter types...
    parameter name: :project_id, in: :path, type: :integer, description: 'project_id'
