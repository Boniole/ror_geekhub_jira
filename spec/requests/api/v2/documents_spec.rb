...
RSpec.describe 'api/v2/documents', type: :request, swagger_doc: 'v2/swagger.yaml' do

  path '/api/v2/projects/{project_id}/documents' do
  ...
  path '/api/v2/projects/{project_id}/documents/{id}' do
    # You'll want to customize the parameter types...
    parameter name: :project_id, in: :path, type: :integer, description: 'project_id'
  ...
  path '/api/v2/tasks/{task_id}/documents' do
    # You'll want to customize the parameter types...
  ...
  path '/api/v2/tasks/{task_id}/documents/{id}' do
    # You'll want to customize the parameter types...
    parameter name: :task_id, in: :path, type: :integer, description: 'task_id'
    parameter name: :id, in: :path, type: :integer, description: 'document_id'
  ...
  path '/api/v2/comments/{comment_id}/documents' do
    # You'll want to customize the parameter types...
  ...
  path '/api/v2/comments/{comment_id}/documents/{id}' do
    # You'll want to customize the parameter types...
    parameter name: :comment_id, in: :path, type: :integer, description: 'comment_id'
    parameter name: :id, in: :path, type: :integer, description: 'document_id'
